...
export let sessionGroupBy = savedSessionFilters.groupBy || "project-conversation";   // "time" | "project" | "branch" | "conversation" | "project-conversation"
...
export function setSessionGroupBy(v: string) { sessionGroupBy = v; }
