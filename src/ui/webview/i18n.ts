...
const EN: Dict = {
    ...
    "sessions.loading.detail": "Restoring the saved session list.",
    "sessions.empty": "No sessions",
    "sessions.empty.detail": "Start a new conversation to create one.",
    ...
    "chat.icon.switchAgent": "Switch adapter",
    ...
    "chat.picker.title": "Choose an adapter for the new session",
    "chat.picker.install": "Click to install: {cmd}",
...
const PT_BR: Dict = {
    ...
    "sessions.loading.detail": "Restaurando a lista de sessões salvas.",
    "sessions.empty": "Nenhuma sessão",
    "sessions.empty.detail": "Inicie uma nova conversa para criar uma.",
    ...
    "chat.icon.switchAgent": "Trocar adaptador",
    ...
    "chat.picker.title": "Escolha um adaptador para a nova sessão",
    "chat.picker.install": "Clique para instalar: {cmd}",
