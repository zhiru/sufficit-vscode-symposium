...
export const agentPickerEl = document.getElementById("agentPicker") as HTMLElement;
export const agentPickerList = document.getElementById("agentPickerList") as HTMLElement;
export const agentPickerTitle = document.getElementById("agentPickerTitle") as HTMLElement;
